...
-- Listage des données de la table recettelily.categorie : ~3 rows (environ)
INSERT INTO `categorie` (`id_categorie`, `nom_categorie`) VALUES
	(1, 'Entrée'),
	(2, 'Plat'),
	(3, 'Dessert');

-- Listage de la structure de table recettelily. ingredients
...
-- Listage des données de la table recettelily.ingredients : ~31 rows (environ)
INSERT INTO `ingredients` (`id_ingredients`, `nom_ingredient`, `unite`, `prix`) VALUES
	(1, 'chouvert', 'nb', 1),
	(2, 'oignons', 'nb', 2),
	(3, 'rizcru', 'g', 2),
	(4, 'viande', 'g', 4),
...
-- Listage des données de la table recettelily.ingredients_recette : ~34 rows (environ)
INSERT INTO `ingredients_recette` (`id_ingredient`, `id_recette`, `quantity`) VALUES
	(3, 1, 2),
	(1, 1, 5),
	(2, 1, 3),
	(4, 1, 4),
...
-- Listage des données de la table recettelily.recette : ~11 rows (environ)
INSERT INTO `recette` (`id_recette`, `nom_recette`, `temps_preparation`, `instructions`, `id_categorie`) VALUES
	(1, 'chou farci', 70, '', 2),
